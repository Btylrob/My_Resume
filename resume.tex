...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Arts in Computer Science, Minor in Mathematics}{Aug. 2025 -- Exp. 2027}
    \resumeSubheading
      {Broward College}{Davie, FL}
      {Associate's in Liberal Arts}{Aug. 2024 -- May 2025}
      \resumeItem{}
      . {GPA}: 3.4 Deans List {Courses:} Discrete Mathematics,Intro to Data Science, SQL Fundamentals, Programming 1
